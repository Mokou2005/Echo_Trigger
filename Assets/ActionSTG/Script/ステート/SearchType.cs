...
namespace StateMachineAI
{
    ...
    public class SearchType : State<EnemySuitAI>
    {
        ...
        //コンストラクタ
        public SearchType(EnemySuitAI owner) : base(owner) { }
        ...
        public override void Stay()
        {
            ...
            if (!isInvisible && distance <= owner.m_viewDistance)
            {
                ...
                if (dot >= threshold)
                {
                    ...
                    {
                        Debug.Log("見つかってしまった！！");
                        owner.ChangeState(AIState.AttackType);
                    }
                }
                else
                {
                    ...
                    if(m_VigilanceLevel<=5){
                        ...
                        owner.ChangeState(AIState.IdleType);
                    }
                }
